...
import { getBeneficiaryListResolver, getCityResolver, getCreditClassificationListResolver, getFaqListResolver, getFinancialInstitutionListResolver, getMannerOfPaymentResolver, getMaritalStatusResolver, getSearchingFeesResolver, getSectorListResolver, getTypeCollateralListResolver } from 'src/app/core/resolvers/data-master.resolver';
